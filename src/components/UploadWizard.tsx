      ...
      {currentStep === 1 && (
        <Card>
          ...
          <CardContent className="space-y-4">
            <div
              className="border-2 border-dashed border-indigo-300 bg-indigo-50/30 rounded-lg p-12 text-center hover:border-indigo-400 hover:bg-indigo-50/50 transition-colors cursor-pointer"
              onDrop={handleDrop}
            ...
            >
              ...
              <input
                type="file"
                multiple
                accept=".pdf,.doc,.docx,.txt,.jpg,.jpeg,.png,.gif,.heic,.heif"
