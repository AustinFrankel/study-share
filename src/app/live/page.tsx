...
import { Clock, Calendar, Bell, CheckCircle2, Loader2, ChevronRight, AlertCircle } from 'lucide-react'
...
export default function LivePage() {
  ...
  const TestCard = ({ test }: { test: TestDate }) => {
    ...
    return (
      <Card
        key={test.id}
        className="relative overflow-hidden hover:shadow-2xl transition-all duration-300 sm:transform sm:hover:-translate-y-2 cursor-pointer border-2 hover:border-indigo-300 bg-white"
            ...
            <form onSubmit={handleWaitlistSubmit} className="space-y-3 sm:space-y-4 mt-3 sm:mt-4">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-2.5 sm:p-3 text-xs sm:text-sm text-blue-800">
                ...
                <ul className="list-disc list-inside space-y-0.5 sm:space-y-1 text-[10px] sm:text-xs">
                  ...
                  <li>Access to practice materials when available</li>
                </ul>
              </div>
